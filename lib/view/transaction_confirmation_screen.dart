                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  buildConfirmRow('Charges', charges.chargedamt.toString()),
                                  buildConfirmRow('Total Amount', '${int.parse(charges.chargedamt.toString())+int.parse(charges.totalcharge.toString())}'),
                                  SizedBox(height: 10),
                                ],
                              ),
                            ],
