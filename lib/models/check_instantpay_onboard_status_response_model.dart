/// ═══════════════════════════════════════════════════════════════
/// CHECK INSTANTPAY USER ONBOARD STATUS RESPONSE MODEL
/// ═══════════════════════════════════════════════════════════════
/// Endpoint: Fetch/checkUserOnboardStatus
/// 
...
class CheckInstantpayOnboardStatusResponseModel {
  final String? respCode;
  final String? respDesc;
  final String? requestId;
  final dynamic rawData;  // Can be String "NOTEXIST" or InstantpayOnboardData object
  
  // Parsed data
  final bool isOnboarded;
  final InstantpayOnboardData? onboardData;

  CheckInstantpayOnboardStatusResponseModel({
    this.respCode,
    this.respDesc,
    this.requestId,
    this.rawData,
  ...
  factory CheckInstantpayOnboardStatusResponseModel.fromJson(Map<String, dynamic> json) {
    bool isOnboarded = false;
    InstantpayOnboardData? onboardData;
    ...
    if (json['data'] != null) {
      if (json['data'] is String) {
        ...
        isOnboarded = true;
        onboardData = InstantpayOnboardData.fromJson(json['data']);
      }
    }

    return CheckInstantpayOnboardStatusResponseModel(
...
/// ═══════════════════════════════════════════════════════════════
/// INSTANTPAY ONBOARD DATA MODEL
/// ═══════════════════════════════════════════════════════════════
/// Contains user onboarding details when user is already onboarded
/// ═══════════════════════════════════════════════════════════════

class InstantpayOnboardData {
  final String? agentOnbrdId;
  final String? userId;
  final String? vendorId;
  final String? serviceIdentifier;
  final String? agentId;
  final String? optional1;          // Account Number
  final String? optional2;          // IFSC Code
  ...
  factory InstantpayOnboardData.fromJson(Map<String, dynamic> json) {
    return InstantpayOnboardData(
  ...
  /// Get account number (stored in optional1)
  String? get accountNumber => optional1;

  /// Get IFSC code (stored in optional2)
  String? get ifscCode => optional2;
